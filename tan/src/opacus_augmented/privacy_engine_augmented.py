...
class PrivacyEngineAugmented:
    ...
    def make_private(
        ...
        *,
        ...
        sample_rate = data_loader.batch_size/len(data_loader.dataset) #1 / len(data_loader)
        expected_batch_size = data_loader.batch_size #int(len(data_loader.dataset) * sample_rate)
